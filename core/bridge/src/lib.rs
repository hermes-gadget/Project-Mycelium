...
pub use ffi::{
    ...
    meshemu_i2c_keyboard_inject_key_byte, meshemu_input_inject_key, meshemu_input_inject_touch,
    ...
    meshemu_wire_set_clock, meshemu_wire_shim_create, meshemu_wire_shim_destroy,
